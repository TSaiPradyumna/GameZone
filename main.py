...
healthimage=pygame.image.load(r"E:\SAI PRADYUMNA\Castle Defender\img\health_box.png")
moneyimage=pygame.image.load(r"E:\SAI PRADYUMNA\Castle Defender\img\coin_1.jpg").convert_alpha()
...
Bullet_Sound=pygame.mixer.Sound(r"E:\MAIN_INTERFACE\CastleDefender\Sounda\Bomb_Blast\Pistol - Firing Sound-[AudioTrimmer.com].mp3")
task_failed=pygame.mixer.Sound(r"E:\SAI PRADYUMNA\Castle Defender\Background_Music\taskFailed.mp3")
task_complete=pygame.mixer.Sound(r"E:\SAI PRADYUMNA\Castle Defender\Background_Music\taskCompleted.mp3")
warning=pygame.mixer.Sound(r"E:\SAI PRADYUMNA\Castle Defender\Background_Music\warning.mp3")
...
mixer.music.play(-1)
# You can trim an object using only pygame: sound = pygame.mixer.Sound (file='music.ogg') raw_array = sound.get_raw () raw_array = raw_array [100000:150000] cut_sound = pygame.mixer.Sound (buffer=raw_array) cut_sound.play (-1)

Bullet_Sound.set_volume(15)
...
class Castle(pygame.sprite.Sprite):
    global x
    def __init__(self,image100,image50,image25,health):
...
castle=Castle(castle_img_100,castle_img_50,castle_img_25,health)
...
while running:
    ...
    if Level_Difficulty<Aim_Difficulty:
        ...
        if pygame.time.get_ticks() - last_enemy > Enemy_Instant_Timer:
            #then create enemies
            enemy=Enemy(Enemy_Health[e],Enemy_animate[e],-100,638,3)
    ...
    if castle.health<=500:
        draw_text("Warning Castle Health is Low(500)",font_30,"BLACK",50,80 )
        warning.play()
