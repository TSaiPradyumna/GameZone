...
app = Ursina()
grass_texture = load_texture('assets/block.png')
stone_texture = load_texture('assets/stone.png')
brick_texture = load_texture('assets/brick.png')
dirt_texture  = load_texture('assets/dirt_block.png')
sky_texture   = load_texture('assets/ss1.png')
arm_texture   = load_texture('assets/no_hand.png')
punch_sound   = Audio('assets/assets_info_loaded',loop = False, autoplay = False)
block_pick = 1
